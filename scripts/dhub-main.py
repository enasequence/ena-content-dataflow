...
# get username and password from .bash_profile (export MYUNAME="")
...
# add path address for saving outputs
...
# def main(): # not using the main function because of global variables issue..

fetch_data_proj()
fetch_data_dhub()
pickle_outputs(dhub_list, 'dhub_list.pkl', save_path) # back up sql results
...
pickle_outputs(dhub_list, 'dhub_list.pkl', save_path)  # save eval result
pickle_outputs(proj_list, 'proj_list.pkl', save_path)
